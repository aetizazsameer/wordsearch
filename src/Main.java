...
public class Main
{
		...
		WordSearch wordsearch;
   		...
   		do{
			...
			do{
				...
				word=scanner.next();
				if(word.length()==1)				//if-else block and findLocation(word) implemented in v1.2
	...
	private static void end(Scanner scanner, int status) throws InterruptedException //end method implemented with parameter scanner in v1.2
	{
		scanner.close();
